...
def write_main_page(streams):
    ...
    main_text = ''.join(
        ...
        '<a href="https://www.instagram.com/p/DLncaEiys_R/" target="_blank" style="border:none !important;"><img height=250px style="border: 1px solid black;" src="assets/tuner.jpg"></a>',
        '</body></html>',
        '''<style>
