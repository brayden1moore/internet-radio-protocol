...
def write_main_page(streams):
    ...
    main_text = '<br>'.join(
        ['<!DOCTYPE html><html><head><meta name="viewport" content="width=device-width, initial-scale=1"><meta charset="UTF-8"><title>Internet Radio Protocol</title><link rel="icon" href="assets/icon-dark.ico" type="image/x-icon"><link rel="shortcut icon" href="assets/icon-dark.ico" type="image/x-icon"><link rel="apple-touch-icon" href="assets/icon-dark.png"></head><body style="font-family:Andale Mono; padding:10vw; padding-top:10px;"><div style="display:flex; justify-content:center"><img src="assets/scudradioworld.png" alt="Loading" height="150px" width="auto" style="margin-left:-25px;"></div>',
        ...
        '', '',
        '<br>'.join([f'''<div id="{v['name']}" style="background-color: #FFFFFF; height: 130px; padding: 10px; border:1px solid black; align-items: center; display: flex;">
