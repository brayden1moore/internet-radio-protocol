...
def write_main_page(streams):
    ...
    main_text = ''.join(
        ...
        '<meta name="viewport" content="width=device-width, initial-scale=1"><meta charset="UTF-8"><title>Internet Radio Protocol</title></head><body style="font-family:Archivo Light; padding:10vw; padding-top:10px;"><div style="display:flex; justify-content:center"><img id="main-logo" src="assets/logo.gif" alt="Loading" width="auto"></div>',
        ...
        '''<a href="https://www.instagram.com/p/scud.works/" target="_blank" style="border:none !important; height:250px;"><img height=250px style="border: 1px solid black;" src="assets/srhand.JPG"></a>
        ...
        .the-header {font-family: "Archivo ExtraBold"; font-size: 18pt; line-height:0.9em; margin-bottom:20px;}
