...
Stream(
        ...
        about = "Two-channel streaming: Channel 1 - music, where anything goes Channel 2 - research-forward talk, education, audio documentary, experimental, and archival [why now] Our connection to the earth is central. Now is a critical time to return to (our) nature and get curious about the intersection of nature with different mediums and practices. DPR is a platform for information exchange and creative expression. We need forums beyond social media and the workplace where people are encouraged to learn, experiment, and share ideas. [why radio] The contemporary definition of “radio” has evolved, expanding beyond the technology and practice of transmitting sound via electromagnetic waves. Especially in independent spaces, “radio” encompasses a shared culture and community. Desire Path Radio celebrates radio broadcast as an accessible tool for discourse, entertainment, and world-building. Radio is, and always has been, radical. [what is a desire path] Desire paths are unofficial routes created by repeated traffic. Reflecting the patterns of human nature and both individual and collective will, these routes reveal an alternate, if not improved, way to move through space and interact with the world around us. DIY forever.",
